...
import F1M1P5.ST.Android.invokenative.DplusReactPackage;
import F1M1P5.ST.Android.invokenative.PushApplication;
import F1M1P5.ST.Android.invokenative.RNUMConfigure;
import F1M1P5.ST.Android.iovation.IovationPackage;
...
public class MainApplication extends PushApplication implements ReactApplication {
    ...
    private final String ORIGIN_SITEID = "9bb81c87-ba4f-4ea1-ae3e-c9e3d4705192";
    ...
    public void onCreate() {
        ...
        RNUMConfigure.init(this, "62e8ec91375d05377ad72cd2", "Umeng", UMConfigure.DEVICE_TYPE_PHONE,
            "8a4d04f4f1f1a20e5bae1233d32e32a5");
        initUpush();
