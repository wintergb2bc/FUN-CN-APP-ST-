...
const Width = 0.78 * ScreenWidth;
const Height = 0.78 * ScreenHeight;
const ToBorderX = 0.11 * ScreenWidth;
const ToBorderY = (ScreenHeight - Width) / 2;
...
export default class GesturePassword extends Component {
  ...
  onStart(e, g) {
    // console.log(e.nativeEvent.pageX - ToBorderX,e.nativeEvent.pageY, ToBorderY);

    let x = isVertical
      ? e.nativeEvent.pageX - ToBorderX
      : e.nativeEvent.pageX - Width / 3.4;
    let y = isVertical
      ? e.nativeEvent.pageY - ToBorderY + window.LoginPatternHeight + 50
      : e.nativeEvent.pageY - 30;

	  console.log(e.nativeEvent.pageY, 'LoginPatternHeight', LoginPatternHeight )
    // let y = isVertical
    //   ? e.nativeEvent.pageY-ToBorderY - Top / 1.25
    //   : e.nativeEvent.pageY - 30;
