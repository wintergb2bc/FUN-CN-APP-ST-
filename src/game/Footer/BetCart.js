...
import NP from '../../lib/utils/numberPrecision';
import {
	SelectionChangeType,
	SelectionStatusType,
	VendorErrorType,
	SpecialUpdateType
} from './../../containers/SbSports/lib/vendor/data/VendorConsts';
...
import BetInfoData from "./../../containers/SbSports/lib/vendor/data/BetInfoData";
...
class BetCart extends React.Component {
	...
	placeBet = async (
		...
		const betlog = (betid, logJSON) => {
			...
			PiwikEvent('betlog_' + this.props.Vendor.configs.VendorName + '_' + BetActiveType, betid, logJSON);
		}
...
const mapDispatchToProps = {
	userInfo_getBalanceSB: ACTION_UserInfo_getBalanceAll,
