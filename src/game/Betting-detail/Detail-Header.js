...
// import { getStyle } from "$LIB/utils/Helper";
					...
					{this.state.showType === 0 ? <View style={{ height: height, display: 'flex', justifyContent: 'center', alignItems: 'center', width: width }}>
						<View style={[styles.Betting_header_score, { width: width }]}>
							<View style={[styles.itemTimes, { width: width * 0.3 }]}>
								...
								<SportImage imgsID={EventData.HomeTeamId} Vendor={Vendor} />
							...
							<View >
								{
									EventData.IsRB ? <View style={styles.itemCenter}>
										<View style={styles.Game_info}>
											<Text style={{ color: EventData.HomeScore > 0 ? '#fff' : '#c8bfbe', fontSize: 40 }}>{EventData.HomeScore}</Text>
											<Text style={{ color: '#fff', padding: 10 }}>-</Text>
											<Text style={{ color: EventData.AwayScore > 0 ? '#fff' : '#c8bfbe', fontSize: 40 }}>{EventData.AwayScore}</Text>
										</View>
										{
										...
										}
										{
											...
											<View style={{display: 'flex',flexDirection: 'row',justifyContent: 'center',alignItems: 'center'}}>
												...
												<Text className="REDSVG-NEXT">{EventData.HomeCorner ?? 0}-{EventData.AwayCorner ?? 0}</Text>
											</View>
										}
									</View>
							...
							<View style={[styles.itemTimes, { width: width * 0.3 }]}>
								...
								<SportImage imgsID={EventData.AwayTeamId} Vendor={Vendor} />
						...
						<View style={styles.Footer_menu}>
							...
							}
							{
								...
								<Text style={{ color: '#bcbec3' }}>暂无视频/动画/数据</Text>
							}
						</View>
					</View> : null}
