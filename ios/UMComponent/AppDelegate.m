...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  //Shareinstall
  [ShareInstallSDK setAppKey:@"77BK676267R6FH" withDelegate:self WithOptions:launchOptions clearCustomParams:NO];

  //TInstall初始化
  [TInstall initInstall:@"2O46BV" setHost:@"https://feaffcodegetm3.com"];

  // Piwik 統計
  [PiwikTracker sharedInstanceWithSiteID:@"9bb81c87-ba4f-4ea1-ae3e-c9e3d4705192" baseURL:[NSURL URLWithString:@"https://analytics.gavelz.com"]];
  ...
  /* Umeng init */
  [RNUMConfigure initWithAppkey:@"62e8ecb9fb3e4a2cba266a5d" channel:@"App Store"];
